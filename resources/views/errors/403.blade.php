        ...
        <div class="max-w-6xl mx-auto px-6 py-16 text-center">
            <div class="bg-white border border-slate-200 text-slate-900 p-6 md:p-8 rounded-2xl shadow-xl mb-8 w-full max-w-2xl">
                <div class="flex justify-center mb-6">
                    <div class="Inbg-sky-50 p-4 rounded-full">
                ...
                <p class="text-lg md:text-xl mb-4 leading-relaxed text-slate-600">{{ __('messages.forbidden_message') }}</p>
                <img src="/img/howtologin.jpeg" alt="How to login" class="mx-auto rounded-xl shadow-md mb-8 max-w-[260px]">
                <a href="{{ config('services.telegram.bot_url') }}" class="inline-flex items-center gap-2 px-6 md:px-10 py-3 md:py-4 rounded-full bg-sky-600 text-white font-bold shadow-lg hover:bg-sky-700 hover:shadow-xl hover:-translate-y-0.5 transition-all mb-8">
